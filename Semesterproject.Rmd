...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap= "Figure 3: Density plots for each scare off event, 10 days before and 14 days after event"}
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap= "Map 1: Wild boar location of WSS_2015_01 scare off, 10 days before, during, and 14 days after event"}
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap= "Map 2: Wild boar location of WSS_2016_01 scare off, 10 days before, during, and 14 days after event"}
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Figure 4: Box Plot with Tukey's Post-Hoc Test for scare off WSS_2016_01, number of GPS locations per day within 200m radius, before, during, and after the scare off event"}
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Figure 5: Box Plot with Tukey's Post-Hoc Test for scare off WSS_2016_05, number of GPS locations per day within 200m radius, before, during, and after the scare off event"}
# Run above function for schreck WSS_2016_01
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Figure 7: Static map (before, during, after) of WSS_2016_01, radius = 200m, 10 days before until 10 days after schreck event"}
...
For a better understanding of the spatial behavior in terms of expansion we summarized all location of each individual in terms of number of data points in *Table 5*. We chose the individual **NAME** with the highest number of GPS data points within the 200m radius around the scare off with the largest number of data points (WSS_2015_01, see densitiy plots above *Figure 3*). However,*Figure 8* shows all of **NAME** data points from 10 days before until 10 days after the scare off events, outside and inside the radius of 200m (orange circle).
...
```
```{r, fig.cap= "Figure 8: Static map of XYs spatial expansion 10 days before, during, and 10 after scare off event of WSS_2015_01"}
