...
*We chose the individual (01) with the highest number of GPS data points within the 200m buffer zone around the schreck with the largest number of data points (WSS_2015_01, see densitiy plots above,). However, this plot shows all of that individuals data points from 10 days before until 10 days after the schreck events, even outside of the buffer zone (orange circle)*
