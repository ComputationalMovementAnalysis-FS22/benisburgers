...
# Results
## Effect of Scare Off on Total Wild Boar Occurance
...
```{r, fig.cap= "Map 1: Wild boar location of WSS_2015_01 scare off, 10 days before, during, and 14 days after event"}
# The reason why we imported the leaflet widgets as html files, instead of running the code in the markdown file has do to with the fact that the leaflet timeslider seems to fail when we present more than 1 interactive map. If you want to see how these maps are generated, please have a look at the code in the previous chunk (generate_interactive_map)
knitr::include_url("p_WSS_2015_01.html")
```

```{r, fig.cap= "Map 2: Wild boar location of WSS_2016_01 scare off, 10 days before, during, and 14 days after event"}
...
## Individual Change in Wild Boars Location
